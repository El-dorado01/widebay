...
import { Search, ShoppingCart, Menu, X, ChevronRightIcon } from 'lucide-react';
        ...
        <div className='mx-auto max-w-7xl rounded-full border border-gray-200 bg-white/95 backdrop-blur supports-backdrop-filter:bg-white/80 shadow-sm'>
          <div className='flex h-16 items-center justify-between px-6'>
            ...
            <div className='flex items-center gap-3'>
              ...
              <Button
                asChild
                className='hidden sm:flex rounded-full bg-primary hover:bg-primary/80 text-white font-medium px-6'
              >
              ...
              <Button
                asChild
                variant='secondary'
                className='rounded-full bg-primary/10 hover:bg-primary/30 text-foreground px-5'
              >
                  ...
                  <div className='flex flex-col h-full space-y-12'>
                    ...
                    <div className='space-y-4 pb-10'>
                      <SheetClose asChild>
                        <Button
                          asChild
                          className='w-full rounded-full bg-primary hover:bg-primary/80 text-lg h-14'
                        >
                          <Link href='/login'>Sign in</Link>
                        </Button>
                      </SheetClose>
                      <SheetClose asChild>
                        <Button
                          asChild
                          className='w-full rounded-full bg-primary/10 hover:bg-primary/30 text-lg h-14 text-foreground'
                        >
                          <Link href='/dashboard/cart'>
                            Cart
